    ...
    switch (eventType) {
      ...
      case EVENTS.BID_REQUESTED:
        ...
        args.bids.forEach(function(bidReq) {
          ...
          if (bidReq.lwflr) {
            lwFloor = bidReq.lwflr.flr;

            const buyerFloor = bidReq.lwflr.bflrs ? bidReq.lwflr.bflrs[bidReq.bidder] : undefined;
      ...
      case EVENTS.BID_RESPONSE:
        ...
        bidResp.originalCpm = prebidGlobal.convertCurrency(args.originalCpm, args.originalCurrency, args.currency);
        bidResp.ttr = args.timeToRespond;
        bidResp.readyToSend = 1;
        bidResp.mediaType = args.mediaType === 'native' ? 2 : (args.mediaType === 'video' ? 4 : 1);
        bidResp.floorData = args.floorData;
